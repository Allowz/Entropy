...
function detectAIType(cwd = process.cwd()) {
  ...
  if (existsSync(join3(cwd, ".agents")) || existsSync(join3(cwd, ".agent"))) {
  ...
  if (existsSync(join3(cwd, ".factory"))) {
    detected.push("droid");
  }
  if (existsSync(join3(cwd, ".kilocode"))) {
    detected.push("kilocode");
  }
  if (existsSync(join3(cwd, ".warp"))) {
    detected.push("warp");
  }
  if (existsSync(join3(cwd, ".augment"))) {
